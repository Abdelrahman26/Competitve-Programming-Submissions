...
/// <<------------------------------------------------------------------------------>>
double n , l;
double arr[int(1e5+6)];
double calc1(double mid)
{
    double t = mid;
    double d = 0;
    double v = 1;
...
int main()
{
    ...
    while(t--)
    {
        ...
        while(s <= e)
        {
            ...
            if(cnt > 100) break;
            mid = (s + e) / 2;
            double a  = calc1(mid); /// time , return distance
            double b  = calc2(mid);
            if(a > b)
                e = mid;
            else
